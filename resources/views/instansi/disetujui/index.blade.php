...
<body id="page-top">
    ...
    <section class="projects-section" style="background-image: linear-gradient(to bottom left, #003366 0%, #660033 100%)" id="projects">
        <div class="container">
            <h1 style="text-align: center;color:white;">Disetujui</h1>
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped bg-light">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('disetujui.show',$item->id)}}" class="btn btn-outline-info btn-sm align-center">Detail</a>
                            </td>
                        </tr>
                        @endforeach
