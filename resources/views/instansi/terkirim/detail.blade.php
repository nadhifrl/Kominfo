...
<body id="page-top">
    ...
    <section class="projects-section" style="background-image: linear-gradient(to top left, #003366 0%, #660033 100%)" id="projects">
        <div class="container">
            <div class="card">
                <div class="card-header bg-light" align="center" style="font-family:times">
                    <h2>Pengajuan Domain Dan Hosting</h2>
                </div>
                <div class="card-body">
                    <form>
                        <div class="form-group"style="font-family:times">
                            <label>Nama Dinas</label>
                            <label class="form-control col-md-8">{{$pengajuan->nama_dinas}}</label>
                        </div>
                        <div class="form-group" style="font-family:times">
                            <label>Alamat</label>
                            <textarea class="form-control col-md-8" Readonly> {{$pengajuan->alamat}}</textarea>
                        </div>
                        <hr>
                        <h5 style="font-family:times"><b>Penanggung Jawab Administratif (Pejabat di Dinas/Intansi)</b></h5>
                        <div class="form-group" style="font-family:times">
                            <label>Nama</label>
                            <label class="form-control col-md-8">{{$pengajuan->nama_penanggung}}</;>
                        </div>
                        <div class="form-group" style="font-family:times">
                            <label>NIP/NIK</label>
                            <label class="form-control col-md-8">{{$pengajuan->nip}}</label>
                        </div>
                        <div class="form-group" style="font-family:times">
                            <label>Pangkat/Golongan</label>
                            <label class="form-control col-md-8">{{$pengajuan->pangkat}}</label>
                        </div>
                        <div class="form-group" style="font-family:times">
                            <label>No Telepon</label>
                            <label class="form-control col-md-8">{{$pengajuan->notelepon}}</label>
                        </div>
                        <hr>
                        <h5 style="font-family:times"><b>Penanggung Jawab Teknis</b></h5>
                        <div class="form-group" style="font-family:times">
                            <label>Nama</label>
                            <label class="form-control col-md-8">{{$pengajuan->nama_teknis}}</label>
                        </div>
                        <div class="form-group" style="font-family:times">
                            <label>No Telepon</label>
                            <label class="form-control col-md-8">{{$pengajuan->notelepon_teknis}}</label>
                        </div>
                        <hr>
                        <h5 style="font-family:times"><b>Data Aplikasi Web</b></h5>
                        <div class="form-group" style="font-family:times">
                            <label>Nama Aplikasi</label>
                            <label class="form-control col-md-8">{{$pengajuan->nama_aplikasi}}</label>
                        </div>
                        <div class="form-group" style="font-family:times">
                            <label>Usulan nama sub-domain :</label>
                                <div class="input-group mb-3">
                                    <label class="form-control col-md-7">{{$pengajuan->sub_domain}}</label>
                                    <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2">.jemberkab.go.id</span>
                                    </div>
                        </div>
                        <div class="form-group" style="font-family:times">
                            <label>Alamat IP **)</label>
                            <textarea class="form-control col-md-8" Readonly>{{$pengajuan->ip}}</textarea>
                        </div>
                        <div class="form-group" style="font-family:times">
                            <label>Fungsi Aplikasi</label>
                            <textarea class="form-control col-md-8" Readonly>{{$pengajuan->fungsi_app}}</textarea>
                        </div>
                    </form>
                    <div class="form-group">
                        <a href="{{route('terkirim.index')}}" class="btn btn-info" style="margin-top: 10px">Kembali</a>
                        <a href="{{route('pengajuan.show',$pengajuan->id)}}" class="btn btn-danger" style="margin-top: 10px" target="_blank">CETAK PDF</a>
                    </div>
                </div>
            </div>
        </div>
